...
// Skill tree layout - 5 domain columns
const skillNodes: SkillNode[] = [
  // === ROOT (Top Center) ===
  { id: "core", name: "Core", icon: Code2, status: "unlocked", description: "Foundation of development", x: 50, y: 5, connections: ["frontend", "backend", "database", "devops", "applied-ai"] },

  // === 5 DOMAIN BRANCHES (Level 1) - Columns at x: 10, 28, 46, 64, 82 ===
  { id: "frontend", name: "Frontend", icon: Code2, status: "unlocked", description: "User interfaces", x: 10, y: 18, connections: ["react"] },
  { id: "backend", name: "Backend", icon: Zap, status: "unlocked", description: "Server-side", x: 28, y: 18, connections: ["nodejs", "python"] },
  { id: "database", name: "Database", icon: Cpu, status: "unlocked", description: "Data storage", x: 46, y: 18, connections: ["postgres", "mongodb"] },
  { id: "devops", name: "DevOps", icon: Workflow, status: "unlocked", description: "Infrastructure", x: 64, y: 18, connections: ["docker", "git"] },
  { id: "applied-ai", name: "Applied AI", icon: Sparkles, status: "unlocked", description: "AI & ML", x: 82, y: 18, connections: ["langchain", "pytorch"] },

  // === FRONTEND COLUMN (x: 10) ===
  { id: "react", name: "React", icon: ReactLogo, status: "unlocked", description: "UI component library", x: 10, y: 34, connections: ["nextjs", "react-native"] },
  { id: "nextjs", name: "Next.js", icon: NextJSLogo, status: "unlocked", description: "Full-stack React", x: 5, y: 50, connections: ["threejs"] },
  { id: "react-native", name: "React Native", icon: Smartphone, status: "unlocked", description: "Mobile apps", x: 15, y: 50, connections: ["expo"] },
  { id: "threejs", name: "Three.js", icon: Blocks, status: "locked", description: "3D graphics", x: 5, y: 66, connections: [] },
  { id: "expo", name: "Expo", icon: Smartphone, status: "unlocked", description: "RN tooling", x: 15, y: 66, connections: [] },

  // === BACKEND COLUMN (x: 28) ===
  { id: "nodejs", name: "Node.js", icon: NodeJSLogo, status: "unlocked", description: "JS runtime", x: 23, y: 34, connections: ["express"] },
  { id: "python", name: "Python", icon: PythonLogo, status: "unlocked", description: "Backend language", x: 33, y: 34, connections: ["fastapi"] },
  { id: "express", name: "Express", icon: ExpressLogo, status: "unlocked", description: "Node framework", x: 23, y: 50, connections: ["graphql"] },
  { id: "fastapi", name: "FastAPI", icon: Zap, status: "unlocked", description: "Python API", x: 33, y: 50, connections: ["graphql"] },
  { id: "graphql", name: "GraphQL", icon: Network, status: "in-progress", description: "Query API", x: 28, y: 66, connections: ["golang", "rust"] },
  { id: "golang", name: "Go", icon: Blocks, status: "locked", description: "Performance", x: 23, y: 82, connections: [] },
  { id: "rust", name: "Rust", icon: Shield, status: "locked", description: "Systems", x: 33, y: 82, connections: [] },

  // === DATABASE COLUMN (x: 46) ===
  { id: "postgres", name: "PostgreSQL", icon: PostgreSQLLogo, status: "unlocked", description: "Relational DB", x: 41, y: 34, connections: ["drizzle"] },
  { id: "mongodb", name: "MongoDB", icon: MongoDBLogo, status: "unlocked", description: "NoSQL DB", x: 51, y: 34, connections: ["redis"] },
  { id: "drizzle", name: "Drizzle", icon: DrizzleLogo, status: "unlocked", description: "Type-safe ORM", x: 41, y: 50, connections: [] },
  { id: "redis", name: "Redis", icon: Cpu, status: "unlocked", description: "Cache", x: 51, y: 50, connections: [] },

  // === DEVOPS COLUMN (x: 64) ===
  { id: "docker", name: "Docker", icon: DockerLogo, status: "unlocked", description: "Containers", x: 59, y: 34, connections: ["kubernetes"] },
  { id: "git", name: "Git", icon: GitLogo, status: "unlocked", description: "Version control", x: 69, y: 34, connections: ["aws"] },
  { id: "kubernetes", name: "Kubernetes", icon: Network, status: "locked", description: "Orchestration", x: 59, y: 50, connections: ["terraform"] },
  { id: "aws", name: "AWS", icon: Network, status: "in-progress", description: "Cloud", x: 69, y: 50, connections: ["terraform"] },
  { id: "terraform", name: "Terraform", icon: Blocks, status: "locked", description: "IaC", x: 64, y: 66, connections: [] },

  // === APPLIED AI COLUMN (x: 82) ===
  { id: "langchain", name: "LangChain", icon: Network, status: "unlocked", description: "LLM framework", x: 77, y: 34, connections: ["agents", "rag"] },
  { id: "pytorch", name: "PyTorch", icon: Cpu, status: "in-progress", description: "Deep learning", x: 87, y: 34, connections: ["huggingface"] },
  { id: "agents", name: "AI Agents", icon: AIAgentLogo, status: "unlocked", description: "Autonomous AI", x: 77, y: 50, connections: [] },
  { id: "rag", name: "RAG", icon: Network, status: "unlocked", description: "RAG systems", x: 82, y: 66, connections: [] },
  { id: "huggingface", name: "Hugging Face", icon: Sparkles, status: "locked", description: "Model hub", x: 92, y: 50, connections: ["mlops"] },
  { id: "mlops", name: "MLOps", icon: Workflow, status: "locked", description: "ML ops", x: 92, y: 66, connections: [] },
]
...
function SkillNodeComponent({
  ...
  return (
    ...
    >
      ...
      {/* Label with background to stand out from lines */}
      <div className={cn(
        "absolute left-1/2 -translate-x-1/2 mt-2 whitespace-nowrap text-center transition-opacity z-10",
        ...
        <span className={cn(
          ...
          node.status === "locked"
            ? "text-[color:var(--muted)]/50 bg-[color:var(--bg-900)]/80"
            : "text-[color:var(--fg)] bg-[color:var(--bg-900)]/90"
        )}>
          {node.name}
        </span>
      </div>
...
function ConnectionLine({
  ...
  return (
    <line
      ...
      strokeLinecap="round"
      strokeOpacity={isUnlocked ? 0.25 : 0.1}
